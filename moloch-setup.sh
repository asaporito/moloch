...
echo 'echo Make sure ethtool -K INTERFACE tx off sg off gro off gso off lro off tso off was ran on the host machine during primary installation. If not please run the command.' >> moloch-setup.sh
